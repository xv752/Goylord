...
const pluginId = "sample-c";
clientIdInput.value = params.get("clientId") || "";
messageInput.value = "hello from sample-c UI";
...
// Listen for plugin events via SSE / polling (same pattern as Go sample)
if (typeof EventSource !== "undefined") {
  const clientId = params.get("clientId");
  if (clientId) {
    log("Ready — C plugin (fully unloadable)");
  }
}
